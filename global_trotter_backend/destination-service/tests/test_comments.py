...
def test_add_comment_valid(client, users):
    token = token_for(client, users.add("Ada", email="commenter@example.com"))
...
def test_added_comment_appears_in_get(client, users):
...
def test_add_comment_rejects_blank_text(client, users):
    token = token_for(client, users.add("Test User"))
...
def test_add_comment_unknown_destination_returns_404(client, users):
    token = token_for(client, users.add("Test User"))
...
def test_add_reply_requires_auth(client, users):
    token = token_for(client, users.add("Test User"))
...
def test_add_reply_valid(client, users):
    author_token = token_for(client, users.add("Ada", email="author@example.com"))
    comment_resp = client.post(
        f"/destinations/{DEST_MARKET}/comments",
        json={"text": "Original comment"},
    ...
    replier_token = token_for(client, users.add("Beno", email="replier@example.com"))
    resp = client.post(
        f"/destinations/{DEST_MARKET}/comments/{comment_id}/replies",
...
def test_add_reply_rejects_blank_text(client, users):
    token = token_for(client, users.add("Test User"))
    comment_resp = client.post(
        f"/destinations/{DEST_MARKET}/comments",
        json={"text": "Original comment"},
...
def test_add_reply_unknown_comment_returns_404(client, users):
    token = token_for(client, users.add("Test User"))
...
def test_add_reply_unknown_destination_returns_404(client, users):
    token = token_for(client, users.add("Test User"))
    comment_resp = client.post(
        f"/destinations/{DEST_MARKET}/comments",
        json={"text": "Original comment"},
...
def test_reply_to_a_reply_nests_indefinitely(client, users):
    token = token_for(client, users.add("Test User"))
    comment_resp = client.post(
        f"/destinations/{DEST_MARKET}/comments",
...
def test_edit_comment_requires_auth(client, users):
    token = token_for(client, users.add("Test User"))
    comment_resp = client.post(
        f"/destinations/{DEST_MARKET}/comments",
        json={"text": "Original comment"},
...
def test_edit_comment_within_window_succeeds(client, users):
    token = token_for(client, users.add("Test User"))
    comment_resp = client.post(
        f"/destinations/{DEST_MARKET}/comments",
        json={"text": "Original comment"},
...
def test_edit_comment_rejects_non_owner(client, users):
    author_token = token_for(client, users.add("Ada", email="author@example.com"))
    comment_resp = client.post(
        f"/destinations/{DEST_MARKET}/comments",
        json={"text": "Original comment"},
    ...
    other_token = token_for(client, users.add("Beno", email="other@example.com"))
    resp = client.patch(
        f"/destinations/{DEST_MARKET}/comments/{comment_id}",
...
def test_edit_comment_after_window_rejected(client, users):
    token = token_for(client, users.add("Test User"))
    comment_resp = client.post(
        f"/destinations/{DEST_MARKET}/comments",
        json={"text": "Original comment"},
...
def test_edit_comment_rejects_blank_text(client, users):
    token = token_for(client, users.add("Test User"))
    comment_resp = client.post(
        f"/destinations/{DEST_MARKET}/comments",
        json={"text": "Original comment"},
...
def test_edit_deleted_comment_rejected(client, users):
    token = token_for(client, users.add("Test User"))
    comment_resp = client.post(
        f"/destinations/{DEST_MARKET}/comments",
        json={"text": "Original comment"},
...
def test_delete_comment_requires_auth(client, users):
    token = token_for(client, users.add("Test User"))
    comment_resp = client.post(
        f"/destinations/{DEST_MARKET}/comments",
        json={"text": "Original comment"},
...
def test_delete_comment_succeeds_and_keeps_thread(client, users):
    token = token_for(client, users.add("Test User"))
    comment_resp = client.post(
        f"/destinations/{DEST_MARKET}/comments",
        json={"text": "Original comment"},
...
def test_delete_comment_rejects_non_owner(client, users):
    author_token = token_for(client, users.add("Ada", email="author@example.com"))
    comment_resp = client.post(
        f"/destinations/{DEST_MARKET}/comments",
        json={"text": "Original comment"},
...
def test_delete_reply_succeeds(client, users):
    token = token_for(client, users.add("Test User"))
    comment_resp = client.post(
        f"/destinations/{DEST_MARKET}/comments",
        json={"text": "Original comment"},
...
def test_destination_comment_count_reflects_comments_and_replies(client, users):
    token = token_for(client, users.add("Test User"))
    comment_resp = client.post(
        f"/destinations/{DEST_MARKET}/comments",
...
def test_destination_comment_count_excludes_deleted(client, users):
    token = token_for(client, users.add("Test User"))
    comment_resp = client.post(
        f"/destinations/{DEST_MARKET}/comments",
        json={"text": "First comment"},
...
def test_favorites_include_comment_count(client, users):
    token = token_for(client, users.add("Test User"))
    client.post(
        f"/destinations/{DEST_MARKET}/comments",
        json={"text": "First comment"},
